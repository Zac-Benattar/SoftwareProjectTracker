    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_date', models.DateTimeField(default=datetime.datetime(2023, 3, 7, 12, 45, 54, 997749, tzinfo=datetime.timezone.utc))),
                ('initial_deadline', models.DateTimeField(default=datetime.datetime(2023, 3, 14, 12, 45, 54, 997749, tzinfo=datetime.timezone.utc))),
                ('current_deadline', models.DateTimeField(default=datetime.datetime(2023, 3, 14, 12, 45, 54, 997749, tzinfo=datetime.timezone.utc))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('success_chance', models.DecimalField(decimal_places=10, max_digits=13)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateTimeField(default=datetime.datetime(2023, 3, 14, 12, 45, 54, 999750, tzinfo=datetime.timezone.utc))),
                ('duration', models.IntegerField(default=0)),
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='projects.project')),
            ],
        ),
